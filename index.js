...
const SUB_PATH = process.env.SUB_PATH || 'wu9527';       // 订阅路径
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'text.wu01.ccwu.cc';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZTgzNTI2MTM0NjIwYTZjYWQ1N2ZlOGUwMDMwNmRjZmMiLCJ0IjoiMTBkOTY1NzQtZGI3NC00ZDFjLTkxODItZjlmMjhiMDZjODQwIiwicyI6IllXRTNOak0zWW1NdFpEazBZUzAwWkdVNUxUbGtaall0TmpReE1EQm1ZamRsTkdVeSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
